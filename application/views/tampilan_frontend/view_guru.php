...
<div id="wrapper">
	...
	<div class="inner-page-banner-area"
		 style="background-image: url('<?php echo base_url() ?>tampilan/img/banner/mengajar.jpg');">
		<div class="container">
					...
					<div class="single-item">
						<div class="lecturers1-item-wrapper">
							<div class="lecturers-img-wrapper">
								...
								<img src="<?php echo base_url() ?>tampilan/gambar/jurusan.png" class="img-responsive"
									 alt="team" style="width:300px; height: 200px">
