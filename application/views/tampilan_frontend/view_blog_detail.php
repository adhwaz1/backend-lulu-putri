...
<div id="wrapper">
	...
	<div class="inner-page-banner-area"
		 style="background-image: url('<?php echo base_url() ?>tampilan/img/banner/smkn1.jpg');">
		<div class="container">
					...
					<div class="row news-details-page-inner">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="news-img-holder">
								<img src="<?php echo base_url() . 'assets/images/' . $image ?>" class="img-responsive"
									 alt="research">
							...
							<ul class="title-bar-high news-comments">
								<li><a href="#"><i class="fa fa-user"
												   aria-hidden="true"></i><span>Oleh :</span> <?php echo $author; ?></a>
								</li>
								<li><a href="#"><i class="fa fa-calender" aria-hidden="true"></i><?php echo $tanggal; ?>
									</a></li>
							...
							<div class="course-details-comments">
								...
								<div class="media">
									<a href="#" class="pull-left">
										<img alt="Comments"
											 src="<?php echo base_url() ?>tampilan/img/course/gambaruser.png"
											 class="media-object" height='60' width='60'>
									</a>
									...
									<div class="contact-form">
										...
										<form action="<?php echo site_url('blog/komentar'); ?>" method="post">
											<fieldset>
												...
												<div class="col-sm-12">
													<div class="form-group">
														<textarea placeholder="Comment" name="komentar"
																  class="textarea form-control" id="form-message"
												...
												<div class="col-sm-12">
													...
													<div class="form-group margin-bottom-none">
														<button type="submit" class="view-all-accent-btn">Berikan
															Komentar
														</button>
													</div>
												</div>
