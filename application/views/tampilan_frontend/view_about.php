			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					...
					<div class="lecturers-contact-info">
						<img src="<?php echo base_url() ?>tampilan/gambar/bejo.png" class="img-responsive" alt="team">
				...
				<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
					...
					<p>Bismillahirrahmaanirrahiim <br>
						Assalaamualaikum Wr. Wb. <br>
						Penerimaan Peserta Didik baru SMKN 1 GARUT tahun pelajaran 2021/2022 akan segera dimulai, kami
						berkomitmen untuk melaksanakan PPDB dengan azas <br>
						1. Objektif <br>
						2. Transparan <br>
						3. Akuntabel <br>
