						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="news-box">
								<div class="news-img-holder">
									<img src="<?php echo base_url() ?>tampilan/gambar/jurusan.png"
										 class="img-responsive" style="width:200px; height:200px" alt="research">
									<ul class="news-date2">
								...
								<ul class="title-bar-high news-comments">
									...
									<li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i>
											<p style="color:black">Deskripsi Coding</p></a></li>
