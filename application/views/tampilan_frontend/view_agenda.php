							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="news-box">
									<div class="news-img-holder">
										<img src="<?php echo base_url() . 'tampilan/img/calender.png' ?>"
									...
									<h3 class="title-news-left-bold"><a href="#"><?php echo $row->agenda_nama; ?></a>
									</h3>
									<ul class="title-bar-high news-comments">
										<li><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span>Oleh :</span>
												<p style="color:black"><?php echo $row->agenda_author; ?></p></a></li>
										<li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i>
												<p style="color:black"><?php echo $row->agenda_deskripsi; ?></p></a>
										</li>
						...
						<div class="sidebar-box">
							<div class="sidebar-box-inner">
								...
								<ul class="sidebar-categories">
									...
									<li><a href="<?php echo site_url('guru'); ?>">Staf Guru</a>
									<li>
									<li><a href="<?php echo site_url('pegawai'); ?>">Staf Pegawai</a>
									<li>
