...
<div id="wrapper">
	...
	<div class="inner-page-banner-area"
		 style="background-image: url('<?php echo base_url() ?>tampilan/img/banner/pegawai.jpg');">
		<div class="container">
						...
						<div class="single-item">
							<div class="lecturers1-item-wrapper">
								<div class="lecturers-img-wrapper">
									...
									<?php if (empty($row->pegawai_photo)): ?>
										<img src="<?php echo base_url() . 'assets/images/blank.png'; ?>"
											 class="img-responsive" alt="team" style="width:300px; height: 200px">
									<?php else: ?>
										<img src="<?php echo base_url() . 'assets/images/' . $row->pegawai_photo; ?>"
											 class="img-responsive" alt="team" style="width:300px; height: 200px">
									<?php endif; ?>
								...
								<div class="lecturers-content-wrapper">
									<h3 class="item-title" style="font-size:17px"><a
												href="#"><?php echo $row->pegawai_nama; ?></a></h3>
									<span class="item-designation"
										  style="font-size:14px"><?php echo $row->pegawai_jabatan; ?></span>
