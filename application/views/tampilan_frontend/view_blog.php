								...
								<div class="news-box">
									<div class="news-img-holder">
										<img src="<?php echo base_url() . 'assets/images/' . $row->tulisan_gambar; ?>"
											 style="width:200px; height:200px" class="img-responsive" alt="research">
										<ul class="news-date2">
									...
									<ul class="title-bar-high news-comments">
										<li><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span>Oleh : <p
															style="color:black"></span><?php echo $row->tulisan_author; ?></p>
											</a></li>
										<li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i>
												<p style="color:black"><?php echo $row->tulisan_kategori_nama; ?></p>
											</a></li>
