								...
								<?php foreach ($data->result_array() as $i) :
									...
									<div class="box-header">
										<a class="btn btn-success btn-flat" data-toggle="modal"
										   data-target="#ModalEdit<?php echo $id; ?>"><span class="fa fa-plus"></span>
											Berikan Sambutan</a>
									</div>
								<?php endforeach; ?>
							<?php } ?>
	...
	<div class="modal fade" id="ModalEdit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?php echo base_url() . 'admin/sambutan/simpan_sambutan' ?>"
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								...
								<textarea value="<?php echo $sambutan; ?>" name="xsambutan"
										  style="width: 300px; height:300px;" required></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" value="<?php echo $kepsek; ?>" name="nama_kepala_sekolah"
									   class="form-control" id="inputUserName" placeholder="Nama Kepala Sekolah"
