        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'admin/ekskul/simpan_ekskul' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" name="xnama" class="form-control" id="inputUserName" placeholder="Nama Ekskul" required onkeypress="return isCharKey(event)">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-4 control-label">Deskripsi</label>
              <div class="col-sm-7">
                <input type="text" name="xdeskripsi" class="form-control" id="inputDeskripsi" placeholder="Deskripsi" required>
              </div>
            </div>
            <div class="form-group">
