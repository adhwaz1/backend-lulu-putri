...
<head>
	...
	<!-- Custom Theme files -->
	<link href="<?php echo base_url() ?>assets/halaman_login/css/style.css" rel="stylesheet" type="text/css"
		  media="all"/>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design"/>
	...
	<link href='http://fonts.googleapis.com/css?family=Lato:100,300,400,700,900,100italic,300italic,400italic,700italic,900italic'
		  rel='stylesheet' type='text/css'>
	<!-- Owl Stylesheets -->
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/halaman_login/css/flexslider.css" type="text/css"
		  media="screen"/>
...
<div class="content">
	...
	<div class="contact-bottom text-center">
		<h4> hubungi kami : </h4>
		<p class="call wow fadeInRight" data-wow-delay="0.4s"><i class="phone wow fadeInLeft" data-wow-delay="0.4s"></i>
			(0262) 233316</p>
